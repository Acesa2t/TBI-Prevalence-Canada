...
census_rep <- read_xlsx("TBI-Prevalence-Canada/Census/Census 2006/census_rep_2006.xlsx")
View(census_rep)
...
saveRDS(census_colsv2, 
        file = "TBI-Prevalence-Canada/Census/Census 2006/census_distributed_2006.rds")
