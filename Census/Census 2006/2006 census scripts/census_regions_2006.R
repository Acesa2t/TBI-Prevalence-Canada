...
census_iso3 <- census_iso3%>%
  filter(!is.na(ISO3))%>%
  filter(!COO%in%c("Caribbean and Bermuda", "Czech Republic", "China and special administrative regions", "USSR, former (Asian component)", "USSR, former (European component)", "USSR, n.o.s."))
