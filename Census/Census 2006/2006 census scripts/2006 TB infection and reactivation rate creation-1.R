...
census <- read.csv(paste0(path.in, "census_classified_2006_v2 copy.csv"), header = T)
...
saveRDS(census, file = paste0(path.out, "estimates_2006_iso3_v1.rds"))
View(census)
write.csv(census,"/Users/ajordan/OneDrive - McGill University/LTBI-Aust-CEA-master/Data/Outputs/estimates_2006_iso3_v1.csv", row.names = FALSE)
...
saveRDS(prob.Inf, file = paste0(path.out, "2006.prob.Inf_iso3_v1.rds"))

saveRDS(census, file = paste0(path.out, "2006_census_iso3_v1.rds"))
