...
census_country <- readRDS("TBI-Prevalence-Canada/Census/Census 2006/census_distributed_2006.rds")
...
saveRDS(census_country, 
        file = "TBI-Prevalence-Canada/Census/Census 2006/census_iso3_2006.rds")
