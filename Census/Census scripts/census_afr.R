...
census_afr <- read_xlsx("3census_whoadded.xlsx")
head(census_afr)
...
write_xlsx(census_afr_new, path = "/Users/ajordan/OneDrive - McGill University/LTBI-Aust-CEA-master/Census/3census_afr.xlsx")
