...
census_nc <- read_xlsx("3census_afr.xlsx")
head(census_nc)
...
write.csv(census_classified, file = "/Users/ajordan/OneDrive - McGill University/LTBI-Aust-CEA-master/Census/4census_classified.csv", row.names = FALSE)
