...
census_cols_expanded <- census_cols[rep(row.names(census_cols), 
                                        ifelse(census_cols$year_of_arrival=="Before 1971",1,
                                               ifelse(census_cols$year_of_arrival == "1971-1980" | census_cols$year_of_arrival == "1981-1990" | census_cols$year_of_arrival == "1991-2000", 10, ifelse(census_cols$year_of_arrival == "2001-2011", 11, 1) ))),]


  # Fill in conditionally-will include people who were not alive
#rep seq
c_rep_year<- census_cols_expanded%>%mutate(
  yarp = ifelse(year_of_arrival == "Before 1971",
                "Before 1971",
                ifelse(year_of_arrival == "1971-1980",
                       ...
                       ifelse(year_of_arrival == "1981-1990",
                              ...
                              ifelse(year_of_arrival == "1991-2000",
                                     ...
                                     ifelse(year_of_arrival == "2001-2011",
                                            seq(from = 2001, to = 2011), 
                                            year_of_arrival
