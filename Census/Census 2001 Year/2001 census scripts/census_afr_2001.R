...
census_afr <- readRDS("TBI-Prevalence-Canada/Census/Census 2001 Year/census_who_2001.rds")
head(census_afr)

# AFRO will need to be split into HIV-high and HIV-low
# Source: http://stoptb.org/global/plan/funding/region/african.asp

afr_high <- c("Botswana", "Burundi", "Cameroon", "Central African Republic", "Congo", "Cote d'Ivoire", "Democratic Republic of Congo", "Ethiopia", "Gabon", "Kenya", "Malawi", "Mozambique", "Namibia", "Nigeria", "Lesotho", "Rwanda", "South Africa", "Swaziland", "Uganda", "United Republic of Tanzania", "Zambia", "Zimbabwe")
afr_high
...
afr <- census_afr%>%filter(WHO_R == "AFRO")
...
saveRDS(census_afr_new, 
        file = "TBI-Prevalence-Canada/Census/Census 2001 Year/census_afr_2001.rds")
