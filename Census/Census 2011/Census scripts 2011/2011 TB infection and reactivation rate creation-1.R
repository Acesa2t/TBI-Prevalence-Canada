...
census <- read.csv(paste0(path.in, "2011census_classified_v2 copy.csv"), header = T)
View(census)
...
saveRDS(census, file = paste0(path.out, "2011estimates_iso3_v1.rds"))

write.csv(census,
          "/Users/ajordan/OneDrive - McGill University/LTBI-Aust-CEA-master/Data/Outputs/2011estimates_iso3_v1.csv", row.names = FALSE)
...
saveRDS(prob.Inf, file = paste0(path.out, "2011.prob.Inf_iso3_v1.rds"))

saveRDS(census, file = paste0(path.out, "2011_census_iso3_v1.rds"))
