...
census_nc <- readRDS("3census2011_afr.rds")
head(census_nc)
...
write.csv(census_classified, file = "/Users/ajordan/OneDrive - McGill University/LTBI-Aust-CEA-master/Census/Census 2011/2011census_classified_v2.csv")
