...
View(census)
write.csv(census,"/Users/ajordan/OneDrive - McGill University/LTBI-Aust-CEA-master/Data/Outputs/2016 estimates_v3.csv", row.names = FALSE)


saveRDS(census, file = paste0(path.out, "2016 estimates_v3.rds"))

#' DATA OUTPUTS =======================================================================================================#

#' Save all the objects that haven't yet been saved.
saveRDS(prob.Inf, file = paste0(path.out, "2016.prob.Inf_v3.rds"))

saveRDS(census, file = paste0(path.out, "2016_census_v3.rds"))
