...
saveRDS(census, file = paste0(path.out, "2016 estimates_iso3_v2.rds"))
...
saveRDS(prob.Inf, file = paste0(path.out, "2016.prob.Inf_iso3_v2.rds"))

saveRDS(census, file = paste0(path.out, "2016_census_iso3_v2.rds"))
