...
regions <- read_xlsx("/Users/ajordan/Library/CloudStorage/OneDrive-McGillUniversity/LTBI-Aust-CEA-master/Census/Census 2016/jme_regional_classifications.xlsx")
regions <- regions%>%
...
census_iso <- readRDS("/Users/ajordan/Library/CloudStorage/OneDrive-McGillUniversity/LTBI-Aust-CEA-master/Census/Provinces/Other Provinces/census_iso3_other_provinces.rds")
...
saveRDS(census_regions, 
        file = "/Users/ajordan/Library/CloudStorage/OneDrive-McGillUniversity/LTBI-Aust-CEA-master/Census/Provinces/Other Provinces/census_who_other_provinces.rds")
